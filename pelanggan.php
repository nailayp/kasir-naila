                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin.php?page=edit_pelanggan&PelangganID=<?php echo $data['PelangganID'] ?>" class="btn btn-info "> Edit </a> |
                                            <a href="proses/proses_pelanggan.php?PelangganID=<?php echo $data['PelangganID'] ?>&aksi=hapus" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus pelanggan?')"> Hapus </a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php } ?>
