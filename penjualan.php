...
{
    // Periksa apakah JumlahProduk kosong
    if (empty($_POST['JumlahProduk'])) {
    echo "<script>
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="proses/proses_penjualan.php?ProdukID=<?php echo $data['ProdukID'] ?>&PenjualanID=<?php echo $penjualan->idauto('nextID'); ?>&aksi=hapus" class="btn btn-warning" onclick="('Apakah anda yakin ingin menghapus penjualan?')">Hapus</a>
                                            </td>
                                        </tr>
                        ...
                        <div class="card-body">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <input type="submit" name="btnPenjualan" value="Selesai" class="btn btn-primary">
                                        </td>
                                    </tr>
                                </table>
                        </div>
