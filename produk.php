                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin.php?page=edit_produk&ProdukID=<?php echo $data['ProdukID'] ?>" class="btn btn-info "> Edit </a> |
                                            <a href="proses/proses_produk.php?ProdukID=<?php echo $data['ProdukID'] ?>&aksi=hapus" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus produk?')" > Hapus </a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php } ?>
